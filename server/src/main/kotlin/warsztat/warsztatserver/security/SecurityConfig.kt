    ...
    override fun configure(http: HttpSecurity) {
        http.cors().and().csrf().disable()
            ...
            .authorizeRequests()
                ...
                .antMatchers("/api/car-part/for-model").authenticated()
                .antMatchers("/api/car-part/**").hasAnyAuthority("MECHANIC", "MANAGER", "ADMIN")
                .antMatchers("/api/token-register/create-tokens").hasAnyAuthority("MANAGER", "ADMIN")
                .antMatchers("/api/token-register/get-tokens").hasAnyAuthority("MANAGER", "ADMIN")
                .antMatchers("/api/token-register/register").permitAll()
